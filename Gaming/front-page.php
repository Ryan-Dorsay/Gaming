			...
			<?php if (have_posts()) :
				...
				<div class="home-columns clearfix">
					...
					<div class="one-half">
						...
						$opinionPosts = new WP_Query('cat=12&posts_per_page=2');
						...
						<span class="horiz-center"><a href="<?php echo get_category_link(12); ?>" class="btn-a">View all Opinion Posts</a></span>
					...
					<div class="one-half last">
						...
						<span class="horiz-center"><a href="<?php echo get_category_link(8); ?>" class="btn-a">View all News Posts</a></span>
